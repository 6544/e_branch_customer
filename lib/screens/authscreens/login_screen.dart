...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(text: "تسجيل الدخول", leading: Container(), actions: []),
      body: Padding(
                ...
                Row(
                  children: [
                    InkWell(
                        ...
                        child: CustomText(text: "تسجيل", fontSize: 16,fontWeight: FontWeight.w600, textDecoration: TextDecoration.none,)),
                    Spacer(),
                    InkWell(
                        onTap: (){
                          Navigation.mainNavigator(context, ForgotPassScreen());
                        },
                        child: CustomText(text: "نسيت كلمة المرور ؟", fontSize: 14, textDecoration: TextDecoration.none,)),
                  ],
                ),
                const SizedBox(height: 50,),
